...
#if 1
/**
    The following function decaration is part of Ambiq Micro Inc. 
    to eliminate the warning due to strict prototype flag used for 
    GCC 13.2 rel1 compiler in AmbiqSuite by default
*/
